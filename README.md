...
I architect end-to-end AI systems —
from model design to backend services to production infrastructure.

Built for scale. Engineered to ship.
...
***Models · APIs · Infrastructure · Scale***
